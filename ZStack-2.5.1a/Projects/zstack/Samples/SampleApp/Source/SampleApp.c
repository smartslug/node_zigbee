 ...
 * GLOBAL VARIABLES
 */
uint8 AppTitle[] = "photoresistance"; //应用程序名称
...
void SampleApp_Send_P2P_Message( void )
{
  ...
  { 
    ...
    if(DATA_PIN == 1)
    {     
      state = 0x31;       //当光敏电阻处于黑暗中时P0.5高电平
      HalUARTWrite(0,"midnight\n", 9);                 //串口显示
  ...
  {     
    state = 0x30;    
    HalUARTWrite(0,"light\n", 6);                      //串口显示
    HalLcdWriteString( "light", HAL_LCD_LINE_3 );      //LCD显示 
  }  
